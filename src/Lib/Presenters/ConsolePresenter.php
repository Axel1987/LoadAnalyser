...
class ConsolePresenter extends Presenter
{
    ...
    protected function printStartUp()
    {
        ...
        $this->liveOrStack(PHP_EOL
            . " " . terminal_style('     PHP LoadAnalyser TOOL     ', null, 'gray') . $queryLogIndication . $liveIndication . PHP_EOL
            . " Created by B. van Hoekelen version " .  LoadAnalyserHandler::VERSION . " PHP v" . phpversion() . PHP_EOL
